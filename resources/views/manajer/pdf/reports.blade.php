...
<body>
    <div class="header">
        <h1>Laporan Transaksi Bank Sampah EcoBank</h1>
    ...
    <div class="meta-info">
        <table>
            ...
            <tr>
                <td><strong>Kelas:</strong> {{ $filters['class'] ?? 'Semua Kelas' }}</td>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="10" class="text-center" style="padding: 20px;">Tidak ditemukan data transaksi yang cocok dengan filter.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
